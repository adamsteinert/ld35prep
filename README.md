# Prep for Ludem Dare 35

I set out to create a game using the phaser engine, having not really written a game before.  This is a collection of odds and ends I
I'm using to learn some basics.

The original framework for the project uses the Phaser ES6 Boilerplate at:
